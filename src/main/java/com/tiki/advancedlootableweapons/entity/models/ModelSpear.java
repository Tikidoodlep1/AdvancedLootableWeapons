...
public class ModelSpear extends ModelBase {
	...
	public ModelSpear() {
		...
		SpearHead.cubeList.add(new ModelBox(SpearHead, 0, 0, -5.0F, -1.001F, -4.0F, 10, 1, 8, 0.0F, false));
		SpearHead.cubeList.add(new ModelBox(SpearHead, 18, 10, -2.0F, -1.6F, -4.001F, 4, 1, 10, 0.0F, false));
		SpearHead.cubeList.add(new ModelBox(SpearHead, 0, 9, -2.0F, -0.4F, -4.001F, 4, 1, 10, 0.0F, false));
		SpearHead.cubeList.add(new ModelBox(SpearHead, 44, 25, -2.0F, -1.6F, -9.0F, 4, 1, 5, 0.0F, false));
		SpearHead.cubeList.add(new ModelBox(SpearHead, 44, 19, -2.0F, -0.4F, -9.0F, 4, 1, 5, 0.0F, false));
		SpearHead.cubeList.add(new ModelBox(SpearHead, 20, 21, 2.0F, -2.0F, -4.0F, 2, 3, 8, 0.0F, false));
		SpearHead.cubeList.add(new ModelBox(SpearHead, 0, 20, -4.0F, -2.0F, -4.0F, 2, 3, 8, 0.0F, false));
		...
		FrontEdgeHeightFillerRight_r1.cubeList.add(new ModelBox(FrontEdgeHeightFillerRight_r1, 12, 20, -0.9838F, -1.5F, -0.5314F, 2, 3, 1, 0.0F, false));
		...
		FrontEdgeHeightFillerLeft_r1.cubeList.add(new ModelBox(FrontEdgeHeightFillerLeft_r1, 22, 21, -0.9762F, -1.5F, -0.5477F, 2, 3, 1, 0.0F, false));
		...
		FrontEdgeFillerRight_r1.cubeList.add(new ModelBox(FrontEdgeFillerRight_r1, 0, 17, -1.0F, -0.501F, -0.5F, 2, 1, 1, 0.0F, false));
		...
		FrontEdgeFillerLeft_r1.cubeList.add(new ModelBox(FrontEdgeFillerLeft_r1, 18, 17, -0.9313F, -0.501F, -0.2589F, 2, 1, 1, 0.0F, false));
		...
		FrontEdgeBottom_r1.cubeList.add(new ModelBox(FrontEdgeBottom_r1, 28, 3, -0.1413F, 0.51F, -0.6889F, 2, 1, 2, 0.0F, false));
		FrontEdgeBottom_r1.cubeList.add(new ModelBox(FrontEdgeBottom_r1, 28, 0, -0.1413F, -1.51F, -0.6889F, 2, 1, 2, 0.0F, false));
		FrontEdgeBottom_r1.cubeList.add(new ModelBox(FrontEdgeBottom_r1, 50, 37, -1.1413F, -0.5F, -1.6889F, 3, 1, 3, 0.0F, false));
		...
		MiddleEdgeHeightRightBottom_r1.cubeList.add(new ModelBox(MiddleEdgeHeightRightBottom_r1, 42, 0, -1.4485F, 0.501F, -6.3433F, 2, 1, 8, 0.0F, false));
		MiddleEdgeHeightRightBottom_r1.cubeList.add(new ModelBox(MiddleEdgeHeightRightBottom_r1, 0, 40, -1.4485F, -1.501F, -6.3433F, 2, 1, 8, 0.0F, false));
		MiddleEdgeHeightRightBottom_r1.cubeList.add(new ModelBox(MiddleEdgeHeightRightBottom_r1, 28, 1, -1.5F, -0.5F, -6.0F, 3, 1, 8, 0.0F, false));
		...
		MiddleHeightBottomLeft_r1.cubeList.add(new ModelBox(MiddleHeightBottomLeft_r1, 12, 41, -0.5402F, 0.501F, -4.3322F, 2, 1, 8, 0.0F, false));
		MiddleHeightBottomLeft_r1.cubeList.add(new ModelBox(MiddleHeightBottomLeft_r1, 38, 34, -0.5402F, -1.501F, -4.3322F, 2, 1, 8, 0.0F, false));
		MiddleHeightBottomLeft_r1.cubeList.add(new ModelBox(MiddleHeightBottomLeft_r1, 0, 31, -1.5F, -0.5F, -4.0F, 3, 1, 8, 0.0F, false));
		...
		BackLeftSlopeBottom_r1.cubeList.add(new ModelBox(BackLeftSlopeBottom_r1, 14, 32, -4.1532F, -0.8522F, -2.51F, 2, 1, 8, 0.0F, false));
		BackLeftSlopeBottom_r1.cubeList.add(new ModelBox(BackLeftSlopeBottom_r1, 32, 24, -1.1532F, -0.0072F, -2.51F, 2, 1, 8, 0.0F, false));
		...
		BackLeftSlopeTop_r1.cubeList.add(new ModelBox(BackLeftSlopeTop_r1, 36, 10, -0.7F, -0.12F, -2.51F, 2, 1, 8, 0.0F, false));
		BackLeftSlopeTop_r1.cubeList.add(new ModelBox(BackLeftSlopeTop_r1, 26, 33, 2.3F, -0.96F, -2.51F, 2, 1, 8, 0.0F, false));
		...
		MiddleRightSlopeBottom_r1.cubeList.add(new ModelBox(MiddleRightSlopeBottom_r1, 24, 42, -0.987F, 0.164F, -4.0F, 1, 1, 8, 0.0F, false));
		...
		MiddleLeftSlopeBottom_r1.cubeList.add(new ModelBox(MiddleLeftSlopeBottom_r1, 42, 43, -0.4998F, -0.5177F, -3.5F, 1, 1, 7, 0.0F, false));
		...
		MiddleRightSlopeTop_r1.cubeList.add(new ModelBox(MiddleRightSlopeTop_r1, 34, 43, -0.5384F, -0.5128F, -2.8F, 1, 1, 6, 0.0F, false));
		...
		MiddleLeftSlopeTop_r1.cubeList.add(new ModelBox(MiddleLeftSlopeTop_r1, 0, 49, -0.2F, -0.5F, -3.0F, 1, 1, 6, 0.0F, false));
		...
		SpearHeadBackSlopeBottomLeft_r1.cubeList.add(new ModelBox(SpearHeadBackSlopeBottomLeft_r1, 18, 9, -1.5F, -0.9909F, -2.8F, 1, 1, 3, 0.0F, false));
		...
		SpearHeadBackSlopeTopLeft_r1.cubeList.add(new ModelBox(SpearHeadBackSlopeTopLeft_r1, 0, 24, -0.4F, -0.4F, -2.0F, 1, 1, 3, 0.0F, false));
		...
		SpearHeadBackBottomLeft_r1.cubeList.add(new ModelBox(SpearHeadBackBottomLeft_r1, 23, 51, -3.3822F, 0.499F, -5.379F, 2, 1, 5, 0.0F, false));
		SpearHeadBackBottomLeft_r1.cubeList.add(new ModelBox(SpearHeadBackBottomLeft_r1, 37, 51, -3.3822F, -1.499F, -5.379F, 2, 1, 5, 0.0F, false));
		SpearHeadBackBottomLeft_r1.cubeList.add(new ModelBox(SpearHeadBackBottomLeft_r1, 12, 21, -4.0822F, -0.5F, -6.079F, 2, 1, 6, 0.0F, false));
		...
		SpearHeadBackSlopeBottomRight_r1.cubeList.add(new ModelBox(SpearHeadBackSlopeBottomRight_r1, 18, 13, -0.5F, -0.5F, -1.5F, 1, 1, 3, 0.0F, false));
		...
		SpearHeadBackSlopeTopRight_r1.cubeList.add(new ModelBox(SpearHeadBackSlopeTopRight_r1, 0, 20, 0.6F, 0.0382F, -2.6F, 1, 1, 3, 0.0F, false));
		...
		SpearHeadBackBottomRight_r1.cubeList.add(new ModelBox(SpearHeadBackBottomRight_r1, 14, 50, 1.55F, 0.49F, -7.8F, 2, 1, 5, 0.0F, false));
		SpearHeadBackBottomRight_r1.cubeList.add(new ModelBox(SpearHeadBackBottomRight_r1, 50, 31, 1.55F, -1.49F, -7.8F, 2, 1, 5, 0.0F, false));
		SpearHeadBackBottomRight_r1.cubeList.add(new ModelBox(SpearHeadBackBottomRight_r1, 48, 9, 2.25F, -0.5F, -8.5F, 2, 1, 6, 0.0F, false));

		SpearHandle = new ModelRenderer(this);
		SpearHandle.setRotationPoint(0.0F, 0.0F, 0.0F);
		SpearHead.addChild(SpearHandle);
		SpearHandle.cubeList.add(new ModelBox(SpearHandle, 276, 282, -1.1F, -1.0F, 8.001F, 2, 1, 134, 0.0F, false));
		SpearHandle.cubeList.add(new ModelBox(SpearHandle, 282, 0, -0.9F, 0.0F, 8.003F, 2, 2, 134, 0.0F, false));
		SpearHandle.cubeList.add(new ModelBox(SpearHandle, 138, 280, -1.1F, 0.001F, 8.001F, 2, 2, 134, 0.0F, false));
		SpearHandle.cubeList.add(new ModelBox(SpearHandle, 282, 141, -1.1F, -3.001F, 8.002F, 2, 2, 134, 0.0F, false));
		...
		SpearHandleDiagonal4_r1.cubeList.add(new ModelBox(SpearHandleDiagonal4_r1, 0, 414, -0.9617F, -2.5433F, 1.51F, 2, 1, 134, 0.0F, false));
		SpearHandleDiagonal4_r1.cubeList.add(new ModelBox(SpearHandleDiagonal4_r1, 414, 277, -0.9617F, 1.5367F, 1.51F, 2, 1, 134, 0.0F, false));
		...
		SpearHandleDiagonal2_r1.cubeList.add(new ModelBox(SpearHandleDiagonal2_r1, 414, 412, -1.35F, 1.19F, 10.01F, 2, 1, 134, 0.0F, false));
		SpearHandleDiagonal2_r1.cubeList.add(new ModelBox(SpearHandleDiagonal2_r1, 138, 416, -1.35F, -2.89F, 10.01F, 2, 1, 134, 0.0F, false));
		...
		SpearHandleHorizontalLeft2_r1.cubeList.add(new ModelBox(SpearHandleHorizontalLeft2_r1, 0, 139, -0.9F, 0.501F, -1.498F, 2, 2, 137, 0.0F, false));
		SpearHandleHorizontalLeft2_r1.cubeList.add(new ModelBox(SpearHandleHorizontalLeft2_r1, 141, 2, -1.1F, 0.5F, -1.497F, 2, 2, 137, 0.0F, false));
		SpearHandleHorizontalLeft2_r1.cubeList.add(new ModelBox(SpearHandleHorizontalLeft2_r1, 0, 0, -1.1F, -2.5F, -1.497F, 2, 2, 137, 0.0F, false));
		SpearHandleHorizontalLeft2_r1.cubeList.add(new ModelBox(SpearHandleHorizontalLeft2_r1, 141, 141, -0.9F, -2.501F, -1.498F, 2, 2, 137, 0.0F, false));
		...
		SpearHandleVerticalTop4_r1.cubeList.add(new ModelBox(SpearHandleVerticalTop4_r1, 0, 9, -1.2F, -0.361F, -0.651F, 2, 2, 2, 0.0F, false));
		SpearHandleVerticalTop4_r1.cubeList.add(new ModelBox(SpearHandleVerticalTop4_r1, 0, 13, -1.0F, -0.36F, -0.651F, 2, 2, 2, 0.0F, false));
		...
		SpearHandleVerticalTop5_r1.cubeList.add(new ModelBox(SpearHandleVerticalTop5_r1, 0, 0, -1.2F, -1.339F, -0.9F, 2, 2, 2, 0.0F, false));
		SpearHandleVerticalTop5_r1.cubeList.add(new ModelBox(SpearHandleVerticalTop5_r1, 0, 4, -1.0F, -1.34F, -0.9F, 2, 2, 2, 0.0F, false));
	}
