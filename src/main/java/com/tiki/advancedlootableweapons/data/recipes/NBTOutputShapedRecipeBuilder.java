...
public class NBTOutputShapedRecipeBuilder implements RecipeBuilder {
    ...
    public NBTOutputShapedRecipeBuilder(ItemStack result) {
        this.result = result;
    }
     ...
     */
    public static NBTOutputShapedRecipeBuilder shaped(ItemStack result) {
        return new NBTOutputShapedRecipeBuilder(result);
    }

    /**
     * Adds a key to the recipe pattern.
     */
    public NBTOutputShapedRecipeBuilder define(Character pSymbol, TagKey<Item> pTag) {
     ...
     * Adds a key to the recipe pattern.
     */
    public NBTOutputShapedRecipeBuilder define(Character pSymbol, ItemLike pItem) {
     ...
     * Adds a key to the recipe pattern.
     */
    public NBTOutputShapedRecipeBuilder define(Character pSymbol, Ingredient pIngredient) {
     ...
     */
    public NBTOutputShapedRecipeBuilder pattern(String pPattern) {
    ...
    public NBTOutputShapedRecipeBuilder unlockedBy(String pCriterionName, CriterionTriggerInstance pCriterionTrigger) {
        this.advancement.addCriterion(pCriterionName, pCriterionTrigger);
        return this;
    }

    public NBTOutputShapedRecipeBuilder group(@Nullable String pGroupName) {
    ...
    public void save(Consumer<FinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pRecipeId) {
        ...
        pFinishedRecipeConsumer.accept(new NBTOutputShapedRecipeBuilder.Result(pRecipeId, this.result, this.group == null ? "" : this.group, this.rows, this.key, this.advancement, new ResourceLocation(pRecipeId.getNamespace(), "recipes/" + this.result.getItem().getItemCategory().getRecipeFolderName() + "/" + pRecipeId.getPath())));
    }
