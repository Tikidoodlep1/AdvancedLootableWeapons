...
public class ItemInit {
    ...
    public static final Map<EquipmentSlot,RegistryObject<UnboundArmorItem>> UNBOUND_DIAMOND_STUDDED_LEATHER_SET = createUnboundDiamondStuddedSet(ArmorMaterials.LEATHER);
    ...
    public static final RegistryObject<HeatableToolPartItem> DAGGER_HEAD = ITEMS.register("dagger_head", () -> new HeatableToolPartItem(1, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    ...
    public static final RegistryObject<HeatableToolPartItem> KABUTOWARI_HEAD_4 = ITEMS.register("kabutowari_head_4", () -> new HeatableToolPartItem(4, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> KABUTOWARI_HEAD_3 = ITEMS.register("kabutowari_head_3", () -> new HeatableToolPartItem(3, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> KABUTOWARI_HEAD_2 = ITEMS.register("kabutowari_head_2", () -> new HeatableToolPartItem(2, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> KABUTOWARI_HEAD = ITEMS.register("kabutowari_head", () -> new HeatableToolPartItem(1, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    ...
    public static final RegistryObject<HeatableToolPartItem> TALWAR_HEAD_2 = ITEMS.register("talwar_head_2", () -> new HeatableToolPartItem(2, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> TALWAR_HEAD = ITEMS.register("talwar_head", () -> new HeatableToolPartItem(1, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    ...
    public static final RegistryObject<HeatableToolPartItem> MACE_HEAD_2 = ITEMS.register("mace_head_2", () -> new HeatableToolPartItem(2, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> MACE_HEAD = ITEMS.register("mace_head", () -> new HeatableToolPartItem(1, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    ...
    public static final RegistryObject<HeatableToolPartItem> STAFF_HEAD_4 = ITEMS.register("staff_head_4", () -> new HeatableToolPartItem(4, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> STAFF_HEAD_3 = ITEMS.register("staff_head_3", () -> new HeatableToolPartItem(3, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> STAFF_HEAD_2 = ITEMS.register("staff_head_2", () -> new HeatableToolPartItem(2, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> STAFF_HEAD = ITEMS.register("staff_head", () -> new HeatableToolPartItem(1, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    ...
    public static final RegistryObject<HeatableToolPartItem> LONGSWORD_HEAD_3 = ITEMS.register("longsword_head_3", () -> new HeatableToolPartItem(3, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> LONGSWORD_HEAD_2 = ITEMS.register("longsword_head_2", () -> new HeatableToolPartItem(2, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> LONGSWORD_HEAD = ITEMS.register("longsword_head", () -> new HeatableToolPartItem(1, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    ...
    public static final RegistryObject<HeatableToolPartItem> BATTLEAXE_HEAD_4 = ITEMS.register("battleaxe_head_4", () -> new HeatableToolPartItem(4, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> BATTLEAXE_HEAD_3 = ITEMS.register("battleaxe_head_3", () -> new HeatableToolPartItem(3, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> BATTLEAXE_HEAD_2 = ITEMS.register("battleaxe_head_2", () -> new HeatableToolPartItem(2, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> BATTLEAXE_HEAD = ITEMS.register("battleaxe_head", () -> new HeatableToolPartItem(1, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    ...
    public static final RegistryObject<HeatableToolPartItem> ZWEIHANDER_HEAD_4 = ITEMS.register("zweihander_head_4", () -> new HeatableToolPartItem(4, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> ZWEIHANDER_HEAD_3 = ITEMS.register("zweihander_head_3", () -> new HeatableToolPartItem(3, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> ZWEIHANDER_HEAD_2 = ITEMS.register("zweihander_head_2", () -> new HeatableToolPartItem(2, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> ZWEIHANDER_HEAD = ITEMS.register("zweihander_head", () -> new HeatableToolPartItem(1, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    ...
    public static final RegistryObject<HeatableToolPartItem> KODACHI_HEAD = ITEMS.register("kodachi_head", () -> new HeatableToolPartItem(1, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    ...
    public static final RegistryObject<HeatableToolPartItem> NODACHI_HEAD_3 = ITEMS.register("nodachi_head_3", () -> new HeatableToolPartItem(3, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> NODACHI_HEAD_2 = ITEMS.register("nodachi_head_2", () -> new HeatableToolPartItem(2, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> NODACHI_HEAD = ITEMS.register("nodachi_head", () -> new HeatableToolPartItem(1, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    ...
    public static final RegistryObject<HeatableToolPartItem> SABRE_HEAD_3 = ITEMS.register("sabre_head_3", () -> new HeatableToolPartItem(3, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> SABRE_HEAD_2 = ITEMS.register("sabre_head_2", () -> new HeatableToolPartItem(2, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> SABRE_HEAD = ITEMS.register("sabre_head", () -> new HeatableToolPartItem(1, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    ...
    public static final RegistryObject<HeatableToolPartItem> MAKHAIRA_HEAD_2 = ITEMS.register("makhaira_head_2", () -> new HeatableToolPartItem(2, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    public static final RegistryObject<HeatableToolPartItem> MAKHAIRA_HEAD = ITEMS.register("makhaira_head", () -> new HeatableToolPartItem(1, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB)).addToRegistryMap());
    ...
    public static final RegistryObject<Item> KOBOLD_STEEL_WHETSTONE = ITEMS.register("kobold_steel_whetstone", () -> new SharpeningStoneItem(new Item.Properties().stacksTo(16).tab(ModCreativeTabs.WEAPON_TAB), ModMaterials.KOBOLD_STEEL));
    public static final RegistryObject<Item> COPPER_WHETSTONE = ITEMS.register("copper_whetstone", () -> new SharpeningStoneItem(new Item.Properties().stacksTo(16).tab(ModCreativeTabs.WEAPON_TAB), ModMaterials.COPPER));
    public static final RegistryObject<Item> SILVER_WHETSTONE = ITEMS.register("silver_whetstone", () -> new SharpeningStoneItem(new Item.Properties().stacksTo(16).tab(ModCreativeTabs.WEAPON_TAB), SILVER));
    public static final RegistryObject<Item> BRONZE_WHETSTONE = ITEMS.register("bronze_whetstone", () -> new SharpeningStoneItem(new Item.Properties().stacksTo(16).tab(ModCreativeTabs.WEAPON_TAB), BRONZE));
    public static final RegistryObject<Item> PLATINUM_WHETSTONE = ITEMS.register("platinum_whetstone", () -> new SharpeningStoneItem(new Item.Properties().stacksTo(16).tab(ModCreativeTabs.WEAPON_TAB), ModMaterials.PLATINUM));
    public static final RegistryObject<Item> STEEL_WHETSTONE = ITEMS.register("steel_whetstone", () -> new SharpeningStoneItem(new Item.Properties().stacksTo(16).tab(ModCreativeTabs.WEAPON_TAB), ModMaterials.STEEL));
    public static final RegistryObject<Item> SHADOW_PLATINUM_WHETSTONE = ITEMS.register("shadow_platinum_whetstone", () -> new SharpeningStoneItem(new Item.Properties().stacksTo(16).tab(ModCreativeTabs.WEAPON_TAB), ModMaterials.SHADOW_PLATINUM));
    public static final RegistryObject<Item> FROST_STEEL_WHETSTONE = ITEMS.register("frost_steel_whetstone", () -> new SharpeningStoneItem(new Item.Properties().stacksTo(16).tab(ModCreativeTabs.WEAPON_TAB), ModMaterials.FROST_STEEL));
    public static final RegistryObject<Item> REFINED_OBSIDIAN_WHETSTONE = ITEMS.register("refined_obsidian_whetstone", () -> new SharpeningStoneItem(new Item.Properties().stacksTo(16).tab(ModCreativeTabs.WEAPON_TAB), ModMaterials.REFINED_OBSIDIAN));
    public static final RegistryObject<Item> CRYSTALLITE_WHETSTONE = ITEMS.register("crystallite_whetstone", () -> new SharpeningStoneItem(new Item.Properties().stacksTo(16).tab(ModCreativeTabs.WEAPON_TAB), ModMaterials.CRYSTALLITE));
    public static final RegistryObject<Item> DUSKSTEEL_WHETSTONE = ITEMS.register("dusksteel_whetstone", () -> new SharpeningStoneItem(new Item.Properties().stacksTo(16).tab(ModCreativeTabs.WEAPON_TAB), ModMaterials.DUSKSTEEL));
