...
public class ItemInit {
	...
	public static final RegistryObject<Item> NUGGET_COPPER = ITEMS.register("nugget_copper", () -> new Item(new Item.Properties().tab(CreativeTabs.MISC_TAB)));
	...
	public static final RegistryObject<Item> HOT_TOOL_HEAD = ITEMS.register("hot_tool_head", () -> new ItemHotToolHead(null, 0, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	
	public static final RegistryObject<Item> HOT_TOOL_ROD_2 = ITEMS.register("hot_tool_rod_2", () -> new ItemHotToolHead(null, 2, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> HOT_TOOL_ROD = ITEMS.register("hot_tool_rod", () -> new ItemHotToolHead((ItemHotToolHead)HOT_TOOL_ROD_2.get(), 1, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> LONG_TOOL_ROD = ITEMS.register("long_tool_rod", () -> new ItemHotToolHead(null, 3, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

	public static final RegistryObject<Item> DAGGER_HOT_TOOL_HEAD_2 = ITEMS.register("dagger_hot_tool_head_2", () -> new ItemHotToolHead(null, 2, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> DAGGER_HOT_TOOL_HEAD = ITEMS.register("dagger_hot_tool_head", () -> new ItemHotToolHead((ItemHotToolHead)DAGGER_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

	public static final RegistryObject<Item> KABUTOWARI_HOT_TOOL_HEAD_5 = ITEMS.register("kabutowari_hot_tool_head_5", () -> new ItemHotToolHead(null, 5, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> KABUTOWARI_HOT_TOOL_HEAD_4 = ITEMS.register("kabutowari_hot_tool_head_4", () -> new ItemHotToolHead((ItemHotToolHead)KABUTOWARI_HOT_TOOL_HEAD_5.get(), 4, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> KABUTOWARI_HOT_TOOL_HEAD_3 = ITEMS.register("kabutowari_hot_tool_head_3", () -> new ItemHotToolHead((ItemHotToolHead)KABUTOWARI_HOT_TOOL_HEAD_4.get(), 3, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> KABUTOWARI_HOT_TOOL_HEAD_2 = ITEMS.register("kabutowari_hot_tool_head_2", () -> new ItemHotToolHead((ItemHotToolHead)KABUTOWARI_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> KABUTOWARI_HOT_TOOL_HEAD = ITEMS.register("kabutowari_hot_tool_head", () -> new ItemHotToolHead((ItemHotToolHead)KABUTOWARI_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

	public static final RegistryObject<Item> TALWAR_HOT_TOOL_HEAD_3 = ITEMS.register("talwar_hot_tool_head_3", () -> new ItemHotToolHead(null, 3, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> TALWAR_HOT_TOOL_HEAD_2 = ITEMS.register("talwar_hot_tool_head_2", () -> new ItemHotToolHead((ItemHotToolHead)TALWAR_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> TALWAR_HOT_TOOL_HEAD = ITEMS.register("talwar_hot_tool_head", () -> new ItemHotToolHead((ItemHotToolHead)TALWAR_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

	public static final RegistryObject<Item> RAPIER_HOT_TOOL_HEAD_4 = ITEMS.register("rapier_hot_tool_head_4", () -> new ItemHotToolHead(null, 4, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> RAPIER_HOT_TOOL_HEAD_3 = ITEMS.register("rapier_hot_tool_head_3", () -> new ItemHotToolHead((ItemHotToolHead)RAPIER_HOT_TOOL_HEAD_4.get(), 3, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> RAPIER_HOT_TOOL_HEAD_2 = ITEMS.register("rapier_hot_tool_head_2", () -> new ItemHotToolHead((ItemHotToolHead)RAPIER_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> RAPIER_HOT_TOOL_HEAD = ITEMS.register("rapier_hot_tool_head", () -> new ItemHotToolHead((ItemHotToolHead)RAPIER_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

	public static final RegistryObject<Item> CLEAVER_HOT_TOOL_HEAD = ITEMS.register("cleaver_hot_tool_head", () -> new ItemHotToolHead(null, 1, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

	public static final RegistryObject<Item> MACE_HOT_TOOL_HEAD_3 = ITEMS.register("mace_hot_tool_head_3", () -> new ItemHotToolHead(null, 3, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> MACE_HOT_TOOL_HEAD_2 = ITEMS.register("mace_hot_tool_head_2", () -> new ItemHotToolHead((ItemHotToolHead)MACE_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> MACE_HOT_TOOL_HEAD = ITEMS.register("mace_hot_tool_head", () -> new ItemHotToolHead((ItemHotToolHead)MACE_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

	public static final RegistryObject<Item> STAFF_HOT_TOOL_HEAD_5 = ITEMS.register("staff_hot_tool_head_5", () -> new ItemHotToolHead(null, 5, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> STAFF_HOT_TOOL_HEAD_4 = ITEMS.register("staff_hot_tool_head_4", () -> new ItemHotToolHead((ItemHotToolHead)STAFF_HOT_TOOL_HEAD_5.get(), 4, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> STAFF_HOT_TOOL_HEAD_3 = ITEMS.register("staff_hot_tool_head_3", () -> new ItemHotToolHead((ItemHotToolHead)STAFF_HOT_TOOL_HEAD_4.get(), 3, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> STAFF_HOT_TOOL_HEAD_2 = ITEMS.register("staff_hot_tool_head_2", () -> new ItemHotToolHead((ItemHotToolHead)STAFF_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> STAFF_HOT_TOOL_HEAD = ITEMS.register("staff_hot_tool_head", () -> new ItemHotToolHead((ItemHotToolHead)STAFF_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

	public static final RegistryObject<Item> LONGSWORD_HOT_TOOL_HEAD_4 = ITEMS.register("longsword_hot_tool_head_4", () -> new ItemHotToolHead(null, 4, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> LONGSWORD_HOT_TOOL_HEAD_3 = ITEMS.register("longsword_hot_tool_head_3", () -> new ItemHotToolHead((ItemHotToolHead)LONGSWORD_HOT_TOOL_HEAD_4.get(), 3, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> LONGSWORD_HOT_TOOL_HEAD_2 = ITEMS.register("longsword_hot_tool_head_2", () -> new ItemHotToolHead((ItemHotToolHead)LONGSWORD_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> LONGSWORD_HOT_TOOL_HEAD = ITEMS.register("longsword_hot_tool_head", () -> new ItemHotToolHead((ItemHotToolHead)LONGSWORD_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

	public static final RegistryObject<Item> BATTLEAXE_HOT_TOOL_HEAD_5 = ITEMS.register("battleaxe_hot_tool_head_5", () -> new ItemHotToolHead(null, 5, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> BATTLEAXE_HOT_TOOL_HEAD_4 = ITEMS.register("battleaxe_hot_tool_head_4", () -> new ItemHotToolHead((ItemHotToolHead)BATTLEAXE_HOT_TOOL_HEAD_5.get(), 4, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> BATTLEAXE_HOT_TOOL_HEAD_3 = ITEMS.register("battleaxe_hot_tool_head_3", () -> new ItemHotToolHead((ItemHotToolHead)BATTLEAXE_HOT_TOOL_HEAD_4.get(), 3, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> BATTLEAXE_HOT_TOOL_HEAD_2 = ITEMS.register("battleaxe_hot_tool_head_2", () -> new ItemHotToolHead((ItemHotToolHead)BATTLEAXE_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> BATTLEAXE_HOT_TOOL_HEAD = ITEMS.register("battleaxe_hot_tool_head", () -> new ItemHotToolHead((ItemHotToolHead)BATTLEAXE_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

	public static final RegistryObject<Item> ZWEIHANDER_HOT_TOOL_HEAD_5 = ITEMS.register("zweihander_hot_tool_head_5", () -> new ItemHotToolHead(null, 5, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> ZWEIHANDER_HOT_TOOL_HEAD_4 = ITEMS.register("zweihander_hot_tool_head_4", () -> new ItemHotToolHead((ItemHotToolHead)ZWEIHANDER_HOT_TOOL_HEAD_5.get(), 4, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> ZWEIHANDER_HOT_TOOL_HEAD_3 = ITEMS.register("zweihander_hot_tool_head_3", () -> new ItemHotToolHead((ItemHotToolHead)ZWEIHANDER_HOT_TOOL_HEAD_4.get(), 3, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> ZWEIHANDER_HOT_TOOL_HEAD_2 = ITEMS.register("zweihander_hot_tool_head_2", () -> new ItemHotToolHead((ItemHotToolHead)ZWEIHANDER_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> ZWEIHANDER_HOT_TOOL_HEAD = ITEMS.register("zweihander_hot_tool_head", () -> new ItemHotToolHead((ItemHotToolHead)ZWEIHANDER_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

	public static final RegistryObject<Item> KODACHI_HOT_TOOL_HEAD_2 = ITEMS.register("kodachi_hot_tool_head_2", () -> new ItemHotToolHead(null, 2, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> KODACHI_HOT_TOOL_HEAD = ITEMS.register("kodachi_hot_tool_head", () -> new ItemHotToolHead((ItemHotToolHead)KODACHI_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

	public static final RegistryObject<Item> NODACHI_HOT_TOOL_HEAD_4 = ITEMS.register("nodachi_hot_tool_head_4", () -> new ItemHotToolHead(null, 4, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> NODACHI_HOT_TOOL_HEAD_3 = ITEMS.register("nodachi_hot_tool_head_3", () -> new ItemHotToolHead((ItemHotToolHead)NODACHI_HOT_TOOL_HEAD_4.get(), 3, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> NODACHI_HOT_TOOL_HEAD_2 = ITEMS.register("nodachi_hot_tool_head_2", () -> new ItemHotToolHead((ItemHotToolHead)NODACHI_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> NODACHI_HOT_TOOL_HEAD = ITEMS.register("nodachi_hot_tool_head", () -> new ItemHotToolHead((ItemHotToolHead)NODACHI_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

	public static final RegistryObject<Item> SABRE_HOT_TOOL_HEAD_4 = ITEMS.register("sabre_hot_tool_head_4", () -> new ItemHotToolHead(null, 4, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> SABRE_HOT_TOOL_HEAD_3 = ITEMS.register("sabre_hot_tool_head_3", () -> new ItemHotToolHead((ItemHotToolHead)SABRE_HOT_TOOL_HEAD_4.get(), 3, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> SABRE_HOT_TOOL_HEAD_2 = ITEMS.register("sabre_hot_tool_head_2", () -> new ItemHotToolHead((ItemHotToolHead)SABRE_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> SABRE_HOT_TOOL_HEAD = ITEMS.register("sabre_hot_tool_head", () -> new ItemHotToolHead((ItemHotToolHead)SABRE_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

	public static final RegistryObject<Item> MAKHAIRA_HOT_TOOL_HEAD_3 = ITEMS.register("makhaira_hot_tool_head_3", () -> new ItemHotToolHead(null, 3, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> MAKHAIRA_HOT_TOOL_HEAD_2 = ITEMS.register("makhaira_hot_tool_head_2", () -> new ItemHotToolHead((ItemHotToolHead)MAKHAIRA_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> MAKHAIRA_HOT_TOOL_HEAD = ITEMS.register("makhaira_hot_tool_head", () -> new ItemHotToolHead((ItemHotToolHead)MAKHAIRA_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

	public static final RegistryObject<Item> SPEAR_HOT_TOOL_HEAD_2 = ITEMS.register("spear_hot_tool_head_2", () -> new ItemHotToolHead(null, 2, true, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
	public static final RegistryObject<Item> SPEAR_HOT_TOOL_HEAD = ITEMS.register("spear_hot_tool_head", () -> new ItemHotToolHead((ItemHotToolHead)SPEAR_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(CreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
