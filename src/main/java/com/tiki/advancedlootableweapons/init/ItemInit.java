...
public class ItemInit {
    ...
    public static final RegistryObject<Item> GRANITE_CLAY = ITEMS.register("granite_clay", () -> new Item(new Item.Properties().tab(ModCreativeTabs.MISC_TAB)));
    public static final RegistryObject<Item> DIORITE_CLAY = ITEMS.register("diorite_clay", () -> new Item(new Item.Properties().tab(ModCreativeTabs.MISC_TAB)));
   ...
   /* public static final RegistryObject<Item> ARMOR_PLATE_IRON = new ItemArmorPlate("armor_plate_iron");
    ...
    public static final RegistryObject<ItemHotToolHead> HOT_TOOL_HEAD = ITEMS.register("hot_tool_head", () -> new ItemHotToolHead(null, 0, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

    public static final RegistryObject<ItemHotToolHead> HOT_TOOL_ROD_2 = ITEMS.register("hot_tool_rod_2", () -> new ItemHotToolHead(null, 2, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> HOT_TOOL_ROD = ITEMS.register("hot_tool_rod", () -> new ItemHotToolHead(HOT_TOOL_ROD_2.get(), 1, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> LONG_TOOL_ROD = ITEMS.register("long_tool_rod", () -> new ItemHotToolHead(null, 3, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

    public static final RegistryObject<ItemHotToolHead> DAGGER_HOT_TOOL_HEAD_2 = ITEMS.register("dagger_hot_tool_head_2", () -> new ItemHotToolHead(null, 2, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> DAGGER_HOT_TOOL_HEAD = ITEMS.register("dagger_hot_tool_head", () -> new ItemHotToolHead(DAGGER_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

    public static final RegistryObject<ItemHotToolHead> KABUTOWARI_HOT_TOOL_HEAD_5 = ITEMS.register("kabutowari_hot_tool_head_5", () -> new ItemHotToolHead(null, 5, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> KABUTOWARI_HOT_TOOL_HEAD_4 = ITEMS.register("kabutowari_hot_tool_head_4", () -> new ItemHotToolHead(KABUTOWARI_HOT_TOOL_HEAD_5.get(), 4, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> KABUTOWARI_HOT_TOOL_HEAD_3 = ITEMS.register("kabutowari_hot_tool_head_3", () -> new ItemHotToolHead(KABUTOWARI_HOT_TOOL_HEAD_4.get(), 3, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> KABUTOWARI_HOT_TOOL_HEAD_2 = ITEMS.register("kabutowari_hot_tool_head_2", () -> new ItemHotToolHead(KABUTOWARI_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> KABUTOWARI_HOT_TOOL_HEAD = ITEMS.register("kabutowari_hot_tool_head", () -> new ItemHotToolHead(KABUTOWARI_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

    public static final RegistryObject<ItemHotToolHead> TALWAR_HOT_TOOL_HEAD_3 = ITEMS.register("talwar_hot_tool_head_3", () -> new ItemHotToolHead(null, 3, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> TALWAR_HOT_TOOL_HEAD_2 = ITEMS.register("talwar_hot_tool_head_2", () -> new ItemHotToolHead(TALWAR_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> TALWAR_HOT_TOOL_HEAD = ITEMS.register("talwar_hot_tool_head", () -> new ItemHotToolHead(TALWAR_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

    public static final RegistryObject<ItemHotToolHead> RAPIER_HOT_TOOL_HEAD_4 = ITEMS.register("rapier_hot_tool_head_4", () -> new ItemHotToolHead(null, 4, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> RAPIER_HOT_TOOL_HEAD_3 = ITEMS.register("rapier_hot_tool_head_3", () -> new ItemHotToolHead(RAPIER_HOT_TOOL_HEAD_4.get(), 3, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> RAPIER_HOT_TOOL_HEAD_2 = ITEMS.register("rapier_hot_tool_head_2", () -> new ItemHotToolHead(RAPIER_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> RAPIER_HOT_TOOL_HEAD = ITEMS.register("rapier_hot_tool_head", () -> new ItemHotToolHead(RAPIER_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

    public static final RegistryObject<ItemHotToolHead> CLEAVER_HOT_TOOL_HEAD = ITEMS.register("cleaver_hot_tool_head", () -> new ItemHotToolHead(null, 1, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

    public static final RegistryObject<ItemHotToolHead> MACE_HOT_TOOL_HEAD_3 = ITEMS.register("mace_hot_tool_head_3", () -> new ItemHotToolHead(null, 3, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> MACE_HOT_TOOL_HEAD_2 = ITEMS.register("mace_hot_tool_head_2", () -> new ItemHotToolHead(MACE_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> MACE_HOT_TOOL_HEAD = ITEMS.register("mace_hot_tool_head", () -> new ItemHotToolHead(MACE_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

    public static final RegistryObject<ItemHotToolHead> STAFF_HOT_TOOL_HEAD_5 = ITEMS.register("staff_hot_tool_head_5", () -> new ItemHotToolHead(null, 5, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> STAFF_HOT_TOOL_HEAD_4 = ITEMS.register("staff_hot_tool_head_4", () -> new ItemHotToolHead(STAFF_HOT_TOOL_HEAD_5.get(), 4, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> STAFF_HOT_TOOL_HEAD_3 = ITEMS.register("staff_hot_tool_head_3", () -> new ItemHotToolHead(STAFF_HOT_TOOL_HEAD_4.get(), 3, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> STAFF_HOT_TOOL_HEAD_2 = ITEMS.register("staff_hot_tool_head_2", () -> new ItemHotToolHead(STAFF_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> STAFF_HOT_TOOL_HEAD = ITEMS.register("staff_hot_tool_head", () -> new ItemHotToolHead(STAFF_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

    public static final RegistryObject<ItemHotToolHead> LONGSWORD_HOT_TOOL_HEAD_4 = ITEMS.register("longsword_hot_tool_head_4", () -> new ItemHotToolHead(null, 4, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> LONGSWORD_HOT_TOOL_HEAD_3 = ITEMS.register("longsword_hot_tool_head_3", () -> new ItemHotToolHead(LONGSWORD_HOT_TOOL_HEAD_4.get(), 3, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> LONGSWORD_HOT_TOOL_HEAD_2 = ITEMS.register("longsword_hot_tool_head_2", () -> new ItemHotToolHead(LONGSWORD_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> LONGSWORD_HOT_TOOL_HEAD = ITEMS.register("longsword_hot_tool_head", () -> new ItemHotToolHead(LONGSWORD_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

    public static final RegistryObject<ItemHotToolHead> BATTLEAXE_HOT_TOOL_HEAD_5 = ITEMS.register("battleaxe_hot_tool_head_5", () -> new ItemHotToolHead(null, 5, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> BATTLEAXE_HOT_TOOL_HEAD_4 = ITEMS.register("battleaxe_hot_tool_head_4", () -> new ItemHotToolHead(BATTLEAXE_HOT_TOOL_HEAD_5.get(), 4, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> BATTLEAXE_HOT_TOOL_HEAD_3 = ITEMS.register("battleaxe_hot_tool_head_3", () -> new ItemHotToolHead(BATTLEAXE_HOT_TOOL_HEAD_4.get(), 3, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> BATTLEAXE_HOT_TOOL_HEAD_2 = ITEMS.register("battleaxe_hot_tool_head_2", () -> new ItemHotToolHead(BATTLEAXE_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> BATTLEAXE_HOT_TOOL_HEAD = ITEMS.register("battleaxe_hot_tool_head", () -> new ItemHotToolHead(BATTLEAXE_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

    public static final RegistryObject<ItemHotToolHead> ZWEIHANDER_HOT_TOOL_HEAD_5 = ITEMS.register("zweihander_hot_tool_head_5", () -> new ItemHotToolHead(null, 5, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> ZWEIHANDER_HOT_TOOL_HEAD_4 = ITEMS.register("zweihander_hot_tool_head_4", () -> new ItemHotToolHead(ZWEIHANDER_HOT_TOOL_HEAD_5.get(), 4, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> ZWEIHANDER_HOT_TOOL_HEAD_3 = ITEMS.register("zweihander_hot_tool_head_3", () -> new ItemHotToolHead(ZWEIHANDER_HOT_TOOL_HEAD_4.get(), 3, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> ZWEIHANDER_HOT_TOOL_HEAD_2 = ITEMS.register("zweihander_hot_tool_head_2", () -> new ItemHotToolHead(ZWEIHANDER_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> ZWEIHANDER_HOT_TOOL_HEAD = ITEMS.register("zweihander_hot_tool_head", () -> new ItemHotToolHead(ZWEIHANDER_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

    public static final RegistryObject<ItemHotToolHead> KODACHI_HOT_TOOL_HEAD_2 = ITEMS.register("kodachi_hot_tool_head_2", () -> new ItemHotToolHead(null, 2, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> KODACHI_HOT_TOOL_HEAD = ITEMS.register("kodachi_hot_tool_head", () -> new ItemHotToolHead(KODACHI_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

    public static final RegistryObject<ItemHotToolHead> NODACHI_HOT_TOOL_HEAD_4 = ITEMS.register("nodachi_hot_tool_head_4", () -> new ItemHotToolHead(null, 4, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> NODACHI_HOT_TOOL_HEAD_3 = ITEMS.register("nodachi_hot_tool_head_3", () -> new ItemHotToolHead(NODACHI_HOT_TOOL_HEAD_4.get(), 3, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> NODACHI_HOT_TOOL_HEAD_2 = ITEMS.register("nodachi_hot_tool_head_2", () -> new ItemHotToolHead(NODACHI_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> NODACHI_HOT_TOOL_HEAD = ITEMS.register("nodachi_hot_tool_head", () -> new ItemHotToolHead(NODACHI_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

    public static final RegistryObject<ItemHotToolHead> SABRE_HOT_TOOL_HEAD_4 = ITEMS.register("sabre_hot_tool_head_4", () -> new ItemHotToolHead(null, 4, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> SABRE_HOT_TOOL_HEAD_3 = ITEMS.register("sabre_hot_tool_head_3", () -> new ItemHotToolHead(SABRE_HOT_TOOL_HEAD_4.get(), 3, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> SABRE_HOT_TOOL_HEAD_2 = ITEMS.register("sabre_hot_tool_head_2", () -> new ItemHotToolHead(SABRE_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> SABRE_HOT_TOOL_HEAD = ITEMS.register("sabre_hot_tool_head", () -> new ItemHotToolHead(SABRE_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());

    public static final RegistryObject<ItemHotToolHead> MAKHAIRA_HOT_TOOL_HEAD_3 = ITEMS.register("makhaira_hot_tool_head_3", () -> new ItemHotToolHead(null, 3, true, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> MAKHAIRA_HOT_TOOL_HEAD_2 = ITEMS.register("makhaira_hot_tool_head_2", () -> new ItemHotToolHead(MAKHAIRA_HOT_TOOL_HEAD_3.get(), 2, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
    public static final RegistryObject<ItemHotToolHead> MAKHAIRA_HOT_TOOL_HEAD = ITEMS.register("makhaira_hot_tool_head", () -> new ItemHotToolHead(MAKHAIRA_HOT_TOOL_HEAD_2.get(), 1, false, new Item.Properties().tab(ModCreativeTabs.WEAPON_TAB).durability(6000).setNoRepair()).addToRegistryMap());
