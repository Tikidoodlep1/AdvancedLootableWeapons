...
public class ItemInit {
    ...
    public static final RegistryObject<Item> KOBOLD_FORGE_HAMMER = ITEMS.register("kobold_forge_hammer", () -> new ItemForgeHammer(ModMaterials.MAT_KOBOLD, new Item.Properties().tab(CreativeTabs.MISC_TAB)));
    public static final RegistryObject<Item> COPPER_FORGE_HAMMER = ITEMS.register("copper_forge_hammer", () -> new ItemForgeHammer(ModMaterials.MAT_COPPER, new Item.Properties().tab(CreativeTabs.MISC_TAB)));
    public static final RegistryObject<Item> SILVER_FORGE_HAMMER = ITEMS.register("silver_forge_hammer", () -> new ItemForgeHammer(ModMaterials.MAT_SILVER, new Item.Properties().tab(CreativeTabs.MISC_TAB)));
    public static final RegistryObject<Item> BRONZE_FORGE_HAMMER = ITEMS.register("bronze_forge_hammer", () -> new ItemForgeHammer(ModMaterials.MAT_BRONZE, new Item.Properties().tab(CreativeTabs.MISC_TAB)));
    public static final RegistryObject<Item> PLATINUM_FORGE_HAMMER = ITEMS.register("platinum_forge_hammer", () -> new ItemForgeHammer(ModMaterials.MAT_PLATINUM, new Item.Properties().tab(CreativeTabs.MISC_TAB)));
    public static final RegistryObject<Item> STEEL_FORGE_HAMMER = ITEMS.register("steel_forge_hammer", () -> new ItemForgeHammer(ModMaterials.MAT_STEEL, new Item.Properties().tab(CreativeTabs.MISC_TAB)));
    public static final RegistryObject<Item> SHADOW_PLATINUM_FORGE_HAMMER = ITEMS.register("shadow_platinum_forge_hammer", () -> new ItemForgeHammer(ModMaterials.MAT_SHADOW_PLATINUM, new Item.Properties().tab(CreativeTabs.MISC_TAB)));
    public static final RegistryObject<Item> FROST_STEEL_FORGE_HAMMER = ITEMS.register("frost_steel_forge_hammer", () -> new ItemForgeHammer(ModMaterials.MAT_FROST_STEEL, new Item.Properties().tab(CreativeTabs.MISC_TAB)));
    public static final RegistryObject<Item> OBSIDIAN_FORGE_HAMMER = ITEMS.register("obsidian_forge_hammer", () -> new ItemForgeHammer(ModMaterials.MAT_OBSIDIAN, new Item.Properties().tab(CreativeTabs.MISC_TAB)));
    public static final RegistryObject<Item> CRYSTALLITE_FORGE_HAMMER = ITEMS.register("crystallite_forge_hammer", () -> new ItemForgeHammer(ModMaterials.MAT_CRYSTALLITE, new Item.Properties().tab(CreativeTabs.MISC_TAB)));
    public static final RegistryObject<Item> DUSKSTEEL_FORGE_HAMMER = ITEMS.register("dusksteel_forge_hammer", () -> new ItemForgeHammer(ModMaterials.MAT_DUSKSTEEL, new Item.Properties().tab(CreativeTabs.MISC_TAB)));
    ...
    public static final RegistryObject<Item> CHAIN_LINK_IRON = ITEMS.register("iron_chain_link", () -> new Item(new Item.Properties().tab(CreativeTabs.WEAPON_TAB)));
    public static final RegistryObject<Item> CHAIN_LINK_GOLD = ITEMS.register("gold_chain_link", () -> new Item(new Item.Properties().tab(CreativeTabs.WEAPON_TAB)));
    public static final RegistryObject<Item> CHAIN_LINK_COPPER = ITEMS.register("copper_chain_link", () -> new Item(new Item.Properties().tab(CreativeTabs.WEAPON_TAB)));
    public static final RegistryObject<Item> CHAIN_LINK_SILVER = ITEMS.register("silver_chain_link", () -> new Item(new Item.Properties().tab(CreativeTabs.WEAPON_TAB)));
    public static final RegistryObject<Item> CHAIN_LINK_BRONZE = ITEMS.register("bronze_chain_link", () -> new Item(new Item.Properties().tab(CreativeTabs.WEAPON_TAB)));
    public static final RegistryObject<Item> CHAIN_LINK_PLATINUM = ITEMS.register("platinum_chain_link", () -> new Item(new Item.Properties().tab(CreativeTabs.WEAPON_TAB)));
    public static final RegistryObject<Item> CHAIN_LINK_STEEL = ITEMS.register("steel_chain_link", () -> new Item(new Item.Properties().tab(CreativeTabs.WEAPON_TAB)));
    public static final RegistryObject<Item> CHAIN_LINK_OBSIDIAN = ITEMS.register("obsidian_chain_link", () -> new Item(new Item.Properties().tab(CreativeTabs.WEAPON_TAB)));
    public static final RegistryObject<Item> CHAIN_LINK_KOBOLD = ITEMS.register("kobold_chain_link", () -> new Item(new Item.Properties().tab(CreativeTabs.WEAPON_TAB)));
    public static final RegistryObject<Item> CHAIN_LINK_SHADOW_PLATINUM = ITEMS.register("shadow_platinum_chain_link", () -> new Item(new Item.Properties().tab(CreativeTabs.WEAPON_TAB)));
    public static final RegistryObject<Item> CHAIN_LINK_FROST_STEEL = ITEMS.register("frost_steel_chain_link", () -> new Item(new Item.Properties().tab(CreativeTabs.WEAPON_TAB)));
    public static final RegistryObject<Item> CHAIN_LINK_CRYSTALLITE = ITEMS.register("crystallite_chain_link", () -> new Item(new Item.Properties().tab(CreativeTabs.WEAPON_TAB)));
    public static final RegistryObject<Item> CHAIN_LINK_DUSKSTEEL = ITEMS.register("dusksteel_chain_link", () -> new Item(new Item.Properties().tab(CreativeTabs.WEAPON_TAB)));
