...
import com.tiki.advancedlootableweapons.tools.ToolDagger2;
...
public static final ToolMaterial MAT_SHADOW_PLATINUM = EnumHelper.addToolMaterial("mar_shadow_platinum", 3, 461, 8.25F, 6.5F, 21).setRepairItem(new ItemStack(INGOT_SHADOW_PLATINUM));
	...
	//Daggers
	public static final Item DAGGER_WOOD = new ToolDagger("dagger_wood", ToolMaterial.WOOD);
	public static final Item DAGGER_IRON = new ToolDagger("dagger_iron", ToolMaterial.IRON);
	public static final Item DAGGER_KOBOLD = new ToolDagger("dagger_kobold", MAT_KOBOLD);
	public static final Item DAGGER_COPPER = new ToolDagger("dagger_copper", MAT_COPPER);
	public static final Item DAGGER_SILVER = new ToolDagger("dagger_silver", MAT_SILVER);
	public static final Item DAGGER_BRONZE = new ToolDagger("dagger_bronze", MAT_BRONZE);
	public static final Item DAGGER_PLATINUM = new ToolDagger("dagger_platinum", MAT_PLATINUM);
	public static final Item DAGGER_STEEL = new ToolDagger("dagger_steel", MAT_STEEL);
	public static final Item DAGGER_SHADOW_PLATINUM = new ToolDagger("dagger_shadow_platinum", MAT_SHADOW_PLATINUM);
	public static final Item DAGGER_FROST_STEEL = new ToolDagger("dagger_frost_steel", MAT_FROST_STEEL);
	public static final Item DAGGER_OBSIDIAN = new ToolDagger("dagger_obsidian", MAT_OBSIDIAN);
	public static final Item DAGGER_CRYSTALLITE = new ToolDagger("dagger_crystallite", MAT_CRYSTALLITE);
	public static final Item DAGGER_DEMONSCALE = new ToolDagger("dagger_DEMONSCALE", MAT_DEMONSCALE);
	
	
	//Armor
	public static final Item HELMET_STEEL = new ArmorBase("helmet_steel", AMAT_STEEL, 1, EntityEquipmentSlot.HEAD);
	public static final Item CHESTPLATE_STEEL = new ArmorBase("chestplate_steel", AMAT_STEEL, 1, EntityEquipmentSlot.CHEST);
	public static final Item LEGGINGS_STEEL = new ArmorBase("leggings_steel", AMAT_STEEL, 2, EntityEquipmentSlot.LEGS);
	public static final Item BOOTS_STEEL = new ArmorBase("boots_steel", AMAT_STEEL, 1, EntityEquipmentSlot.FEET);
}
