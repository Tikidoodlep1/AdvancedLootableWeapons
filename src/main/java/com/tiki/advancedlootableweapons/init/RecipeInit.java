...
public class RecipeInit {
	...
	public static final RegistryObject<RecipeSerializer<AnvilTwoToolForgingRecipe>> ANVIL_TWO_TOOL_FORGING_RECIPE = RECIPE_SERIALIZERS.register("anvil_two_tool_forging",
