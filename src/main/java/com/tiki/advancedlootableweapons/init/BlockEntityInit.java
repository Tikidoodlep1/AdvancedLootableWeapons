...
public class BlockEntityInit {
	...
	public static final RegistryObject<BlockEntityType<AlloyFurnaceBlockEntity>> ALLOY_FURNACE_TE = 
			BLOCK_ENTITIES.register("alloy_furnace_te", () -> BlockEntityType.Builder.of(AlloyFurnaceBlockEntity::new, BlockInit.ALLOY_FURNACE.get()).build(null));
	
	public static final RegistryObject<BlockEntityType<ForgeBlockEntity>> FORGE_TE = 
			BLOCK_ENTITIES.register("forge_te", () -> BlockEntityType.Builder.of(ForgeBlockEntity::new, BlockInit.FORGE.get()).build(null));
	
	public static final RegistryObject<BlockEntityType<JawCrusherBlockEntity>> JAW_CRUSHER_TE =
			BLOCK_ENTITIES.register("jaw_crusher_te", () -> BlockEntityType.Builder.of(JawCrusherBlockEntity::new, BlockInit.JAW_CRUSHER.get()).build(null));
