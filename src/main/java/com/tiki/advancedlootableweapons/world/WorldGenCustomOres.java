...
public class WorldGenCustomOres implements IWorldGenerator {
	...
	public WorldGenCustomOres(){
		...
		rock_gypsum = new WorldGenMinable(BlockInit.gypsum.getDefaultState(), 12, Predicates.or(BlockMatcher.forBlock(Blocks.STONE), BlockMatcher.forBlock(Blocks.SANDSTONE)));
