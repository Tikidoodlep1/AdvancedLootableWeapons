package com.tiki.advancedlootableweapons.item;
...
public class ItemInit {
	...
	public static final RegistryObject<Item> INGOT_COPPER = ITEMS.register("ingot_copper", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
	...
	public static final RegistryObject<Item> NUGGET_COPPER = ITEMS.register("nugget_copper", () -> new Item(new Item.Properties().tab(CreativeModeTab.TAB_MATERIALS)));
