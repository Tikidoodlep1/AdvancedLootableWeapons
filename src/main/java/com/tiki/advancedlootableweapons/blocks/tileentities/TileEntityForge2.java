...
//	@SuppressWarnings("deprecation")
	public TileEntityForge2(boolean needsFuel, boolean needsIgnition) {
	...
	public void update()
	{
		if(!this.world.isRemote) {
			...
			if(currentTemp > minTemp && this.increaseFrames <= 0) {
				...
				this.currentTemp += (1.078D * ConfigHandler.FORGE_TEMP_INCREASE_MULTIPLIER);this.currentTemp += 1.078D;
				this.increaseFrames--;
			}else {
