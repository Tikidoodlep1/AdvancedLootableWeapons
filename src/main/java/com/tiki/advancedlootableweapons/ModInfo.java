...
public class ModInfo {
	...
	public static final String VER = "1.2.0-1.12.2";
	public static final String LOAD_AFTER = "required-after:FML;after:thermalfoundation;after:mekanismtools;after:appliedenergistics2;after:tconstruct;after:botania";
