package tiki.rotn.advancedlootableweapons.compat.jei;
...
import tiki.rotn.advancedlootableweapons.compat.jei.alloyFurnace.AlloyFurnaceRecipeCategory;
import tiki.rotn.advancedlootableweapons.compat.jei.alloyFurnace.AlloyFurnaceRecipeMaker;
import tiki.rotn.advancedlootableweapons.compat.jei.anvilForging.AnvilForgingRecipeCategory;
import tiki.rotn.advancedlootableweapons.compat.jei.anvilForging.AnvilForgingRecipeMaker;
import tiki.rotn.advancedlootableweapons.compat.jei.drum.DrumRecipeCategory;
import tiki.rotn.advancedlootableweapons.compat.jei.drum.DrumRecipeMaker;
import tiki.rotn.advancedlootableweapons.compat.jei.mill.MillRecipeCategory;
import tiki.rotn.advancedlootableweapons.compat.jei.mill.MillRecipeMaker;
import tiki.rotn.advancedlootableweapons.compat.jei.tanningRack.TanningRackRecipeCategory;
import tiki.rotn.advancedlootableweapons.compat.jei.tanningRack.TanningRackRecipeMaker;
import tiki.rotn.advancedlootableweapons.init.BlockInit;
import tiki.rotn.advancedlootableweapons.inventory.AlloyFurnace.ContainerAlloyFurnace;
import tiki.rotn.advancedlootableweapons.inventory.AlloyFurnace.GuiAlloyFurnace;
import tiki.rotn.advancedlootableweapons.inventory.ForgeWeapon.ContainerForgeWeapon;
import tiki.rotn.advancedlootableweapons.inventory.ForgeWeapon.GuiForgeWeapon;
import tiki.rotn.advancedlootableweapons.inventory.Mill.ContainerMill;
import tiki.rotn.advancedlootableweapons.inventory.Mill.GuiMill;
import tiki.rotn.advancedlootableweapons.inventory.TanningRack.ContainerTanningRack;
import tiki.rotn.advancedlootableweapons.inventory.TanningRack.GuiTanningRack;
