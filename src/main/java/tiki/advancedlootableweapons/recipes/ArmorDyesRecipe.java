...
public class ArmorDyesRecipe extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe> implements IRecipe {
	...
	public boolean matches(InventoryCrafting inv, World worldIn) {
        ...
        for (int i = 0; i < inv.getSizeInventory(); ++i) {
            ...
            if (!itemstack1.isEmpty()) {
                if (itemstack1.getItem() instanceof ItemArmor)  {
                    ...
                    if (armor.getArmorMaterial() != ItemInit.CAMAT_DIAMOND || !itemstack.isEmpty()) {
                        return false;
                    }
        ...
        System.out.println("Does armor recipe match: " + (!itemstack.isEmpty() && !list.isEmpty()));
        ...
        for (int k = 0; k < inv.getSizeInventory(); ++k) {
            ...
            if (!itemstack1.isEmpty()) {
                if (itemstack1.getItem() instanceof ItemArmor) {
                    ...
                    if (itemarmor.getArmorMaterial() != ItemInit.CAMAT_DIAMOND || !itemstack.isEmpty()) {
