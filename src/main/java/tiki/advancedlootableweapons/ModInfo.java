...
public class ModInfo {
	...
	public static final String VER = "1.4.0-1.12.2";
	public static final String LOAD_AFTER = "required-after:FML;after:betterwithmods;before:contenttweaker;before:crafttweaker;after:thermalfoundation;after:mekanismtools;after:appliedenergistics2;after:tconstruct;after:botania;after:spartanweaponry";
